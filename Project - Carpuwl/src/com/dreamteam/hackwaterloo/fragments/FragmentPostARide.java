...
public class FragmentPostARide extends SherlockFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mSpinnerFrom = (Spinner) rootView.findViewById(R.id.post_ride_spinner_depart_from);
        mSpinnerTo = (Spinner) rootView.findViewById(R.id.post_ride_spinner_arrive_at);
